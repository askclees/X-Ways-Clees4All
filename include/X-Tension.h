...
//1.41 added GetCellText and GetColumnText

typedef LONG (__stdcall * fptr_XWF_GetCellText) (LONG nItemID, LPVOID lpPointer,
    DWORD nFlags, WORD nColIndex, LPWSTR lpBuffer, DWORD nBufferLen);

typedef LONG (__stdcall * fptr_XWF_GetColumnTitle) (WORD nWndNo,
    WORD nColIndex, LPWSTR lpBuffer);
...
//1.41 added getycelltext and getcolumntitle
extern fptr_XWF_GetCellText XWF_GetCellText;
extern fptr_XWF_GetColumnTitle XWF_GetColumnTitle;
...
#define XWF_VSPROP_HASHTYPE1 20
#define XWF_VSPROP_HASHTYPE2 21
...
// XT_About
LONG DLL_EXPORT XT_About(HANDLE hParentWnd, void* lpReserved);
...
// XT_ProcessItemEx
//LONG DLL_EXPORT XT_ProcessItemEx(LONG nItemID, HANDLE hItem, void* lpReserved);

// XT_ProcessSearchHit
//LONG DLL_EXPORT XT_ProcessSearchHit(struct SearchHitInfo* info);
