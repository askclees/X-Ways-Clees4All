...
//1.41 added getcelltext and getcolumn title
...
LONG __stdcall XT_RetrieveFunctionPointers()
{
	...
	//1.41 Added XWF_GetColumnTitle and
    XWF_GetColumnTitle = (fptr_XWF_GetColumnTitle) GetProcAddress(Hdl, "XWF_GetColumnTitle");
    XWF_GetCellText = (fptr_XWF_GetCellText) GetProcAddress(Hdl, "XWF_GetCellText");
   return 1;
}
